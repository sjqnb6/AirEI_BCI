...
import NetworkStreamOut_.NetworkStreamOut;
...
public class W_Networking extends Widget {
    ...
    public W_Networking(GUI MAIN) {
        ...
        cp5ElementsToCheck.add((Controller) guideButton);
        cp5ElementsToCheck.add((Controller) dataOutputsButton);
        cp5ElementsToCheck.add((Controller) cp5_networking_dropdowns.get(ScrollableList.class, "dataType1"));
        cp5ElementsToCheck.add((Controller) cp5_networking_baudRate.get(ScrollableList.class, "baud_rate"));
    }
