...
public class GF {
    ...
    public static void VertScale_AR(GUI MAIN, int n) {
        MAIN.settings.arVertScaleSave = n;
    ...
    public static void Duration_AR(GUI MAIN, int n) {
        ...
        MAIN.settings.arHorizScaleSave = n;
