...
public class MenuList extends Controller {
    ...
    public MenuList(ControlP5 c, String theName, int theWidth, int theHeight, PFont theFont, GUI pApplet) {
        ...
        int a = getWidth();
        int b = getHeight();
        menu = pApplet.createGraphics(getWidth(),getHeight());
        ...
        setView(new ControllerView<MenuList>() {
                    ...
                    public void display(PGraphics pg, MenuList t) {
                        ...
                        if (isMouseOver()) {
                            ...
                            menu.fill(pApplet.OPENBCI_DARKBLUE, 100);
                            if(ty > 0){
    ...
    public void updateMenu() {
        ...
        int range = ceil(((float) (getHeight()) /(itemHeight))+1);
        ...
        for (int i=i0; i<i1; i++) {
            ...
            if (i == activeItem) {
                menu.stroke(pApplet.TURN_ON_GREEN);
                menu.strokeWeight(1);
                menu.fill(pApplet.TURN_ON_GREEN);
                menu.rect(0, 0, getWidth()-1, itemHeight-1 );
                menu.noStroke();
            } else {
                menu.rect(0, 0, getWidth(), itemHeight-1 );
            }
            menu.fill(pApplet.OPENBCI_DARKBLUE);
            menu.textFont(menuFont);
