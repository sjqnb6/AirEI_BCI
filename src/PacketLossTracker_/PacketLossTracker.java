...
import TimeTrackingQueue_.TimeTrackingQueue;

import java.util.ArrayList;
import java.util.List;

import static Debugging_.GF.outputInfo;
...
public class PacketLossTracker {
    ...
    public PacketLossTracker(int _sampleIndexChannel, int _timestampChannel, int _minSampleIndex, int _maxSampleIndex) {
    ...
    public PacketLossTracker( int _sampleIndexChannel, int _timestampChannel, TTQTimeProvider _timeProvider) {
