...
import W_EMGJoystick_.EmgJoystickSmoothing;
...
public class SessionSettings {
    ...
    public int accVertScaleSave;
    public int accHorizScaleSave;
    //FFT plot settings,
    public int fftMaxFrqSave;
    public int fftMaxuVSave;
    public int fftLogLinSave;
    public int fftSmoothingSave;
    public int fftFilterSave;
    //Analog Read settings
    public int arVertScaleSave;
    public int arHorizScaleSave;
    //Headplot settings
    public int hpIntensitySave;
    public int hpPolaritySave;
    public int hpContoursSave;
    public int hpSmoothingSave;
    //default data types for streams 1-4 in Networking widget
    public int nwDataType1;
    public int nwDataType2;
    public int nwDataType3;
    public int nwDataType4;
    ...
    public String[] arHorizScaleArray = {"Sync", "1 sec", "3 sec", "5 sec", "10 sec", "20 sec"};
    ...
    public String[] spectMaxFrqArray = {"20 Hz", "40 Hz", "60 Hz", "100 Hz", "120 Hz", "250 Hz"};
    public String[] spectSampleRateArray = {"30 Min.", "6 Min.", "3 Min.", "1.5 Min.", "1 Min."};
    ...
    public String controlEventDataSource; //Used for output message on system start
