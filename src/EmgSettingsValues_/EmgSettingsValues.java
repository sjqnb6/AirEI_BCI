...
public class EmgSettingsValues {
    ...
    public transient float[] outputNormalized;
    //These values change during calculations
    public transient float[] upperThreshold;
    public transient float[] lowerThreshold;
    public transient float[] averageuV;
